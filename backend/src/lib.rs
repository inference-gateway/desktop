...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            projects::attach_pick,
            projects::attach_bytes,
            projects::list_project_files,
            projects::checkpoint_content_project,
            projects::undo_content_project,
            projects::redo_content_project,
            projects::content_can_undo,
