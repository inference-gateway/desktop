...
export function TopBar() {
  ...
  return (
    <header id="top-bar" className="flex items-center gap-3 border-b border-border bg-card px-4 py-[0.6rem]">
      ...
      <span title="Installed versions" className="shrink-0 whitespace-nowrap text-[0.65rem] text-muted-foreground">
        {versionBadge}
      </span>
      {showUpdateBanner && (
        <button
